...
skeleton_r = pygame.image.load("skeletone_r.png")
skeleton_l = pygame.image.load("skeletone_l.png")
...
npc_2_l = pygame.image.load('npc_2_l.png')
npc_2_l.set_colorkey((255, 255, 255))
npc_2_r = pygame.image.load('npc_2_r.png')
npc_2_r.set_colorkey((255, 255, 255))
npc_3_l = pygame.image.load('npc_3_l.png')
npc_3_l.set_colorkey((255, 255, 255))
npc_3_r = pygame.image.load('npc_3_r.png')
npc_3_r.set_colorkey((255, 255, 255))
npc_4_l = pygame.image.load('npc_4_l.png')
npc_4_l.set_colorkey((255, 255, 255))
npc_4_r = pygame.image.load('npc_4_r.png')
npc_4_r.set_colorkey((255, 255, 255))
menu = pygame.image.load('Menu.png')
menu.set_colorkey((255, 255, 255))
""""Правила"""
rules = pygame.image.load('npc_4_r.png')
...
class Npc_2(Nepice):
    ...
    def draw(self, hp):
        if self.nx == -1:
            g_l_s = npc_2_l.get_rect(topleft=(self.x, self.y))
            screen.blit(npc_2_l, g_l_s)
        else:
            g_l_s = npc_2_r.get_rect(topleft=(self.x, self.y))
            screen.blit(npc_2_r, g_l_s)
        pygame.draw.rect(screen, (0, 0, 0), (self.x - 2, self.y - 12, 72, 12), 4)
        pygame.draw.rect(
            screen, (255, 0, 0), (self.x, self.y - 10, int(70 * hp / 12), 10))
...
class Npc_3(Nepice):
    ...
    def draw(self, hp):
        if self.nx == -1:
            g_l_s = npc_3_l.get_rect(topleft=(self.x, self.y))
            screen.blit(npc_3_l, g_l_s)
        else:
            g_l_s = npc_3_r.get_rect(topleft=(self.x, self.y))
            screen.blit(npc_3_r, g_l_s)
        pygame.draw.rect(screen, (0, 0, 0), (self.x - 2, self.y - 12, 72, 12), 4)
        pygame.draw.rect(
            screen, (255, 0, 0), (self.x, self.y - 10, int(70 * hp / 12), 10))
...
class Npc_4(Nepice):
    ...
    def draw(self, hp):
        if self.nx == -1:
            g_l_s = npc_4_l.get_rect(topleft=(self.x, self.y))
            screen.blit(npc_4_l, g_l_s)
        else:
            g_l_s = npc_4_r.get_rect(topleft=(self.x, self.y))
            screen.blit(npc_4_r, g_l_s)
        pygame.draw.rect(screen, (0, 0, 0), (self.x - 2, self.y - 12, 72, 12), 4)
        pygame.draw.rect(
            screen, (255, 0, 0), (self.x, self.y - 10, int(70 * hp / 12), 10))
...
class Menu(Nepice):
    ...
    def draw(self, hp):
        if self.nx == -1:
            g_l_r = menu.get_rect(topleft=(self.x, self.y))
            screen.blit(menu, g_l_r)
        else:
            g_l_r = menu.get_rect(topleft=(self.x, self.y))
            screen.blit(menu, g_l_r)
        pygame.draw.rect(screen, (0, 0, 0), (self.x - 2, self.y - 12, 72, 12), 4)
...
def add_goblin():
    npc.append(Goblin(randint(50, 1100), randint(50, 700), 12))


def add_skeleton():
    npc.append(Skeleton(randint(50, 1100), randint(50, 700), 12))


def add_npc_2():
    npc.append(Npc_2(randint(50, 1100), randint(50, 700), 18))


def add_npc_3():
    npc.append(Npc_3(randint(50, 1100), randint(50, 700), 20))


def add_npc_4():
    npc.append(Npc_4(randint(50, 1100), randint(50, 700), 30))
...
def show_rules():
    """ меняет состояние, показываются ли правила"""
    global show_rules
    show_rules = not show_rules


npc_dict = {
    pygame.K_1: add_goblin,
    pygame.K_2: add_skeleton,
    pygame.K_3: add_npc_2,
    pygame.K_4: add_npc_3,
    pygame.K_5: add_npc_4

}

kill_npc_button = Button(43, 60, 170, 40, "Уничтожить мишени", kill_npc)
add_goblin_button = Button(232, 60, 170, 40, "Добавить гоблина", add_goblin)
add_skeleton_button = Button(420, 60, 170, 40, "Добавить скелета", add_skeleton)
add_npc_2_button = Button(610, 60, 170, 40, "Добавить Npc_2", add_npc_2)
add_npc_3_button = Button(800, 60, 170, 40, "Добавить Npc_3", add_npc_3)
add_npc_4_button = Button(990, 60, 170, 40, "Добавить Npc_4", add_npc_4)
add_menu_button = Button(505, 120, 170, 40, "Меню", back_to_menu)
add_rules_buttom = Button(325, 120, 170, 40, "Правила", show_rules)
...
while running:
    ...
    g_l_r1 = wall_hor.get_rect(topleft=(0, 825))
