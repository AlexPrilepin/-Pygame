...
kill_npc_button = Button(43, 60, 170, 40, "Уничтожить мишени K_0", kill_npc)
add_goblin_button = Button(232, 60, 170, 40, "Добавить гоблина K_1", add_goblin)
add_skeleton_button = Button(420, 60, 170, 40, "Добавить скелета K_2", add_skeleton)
add_npc_2_button = Button(610, 60, 170, 40, "Добавить Npc_2 K_3", add_npc_2)
add_npc_3_button = Button(800, 60, 170, 40, "Добавить Npc_3 K_4", add_npc_3)
add_npc_4_button = Button(990, 60, 170, 40, "Добавить Npc_4 K_5", add_npc_4)
add_menu_button = Button(610, 120, 170, 40, "Меню", back_to_menu)
add_rules_buttom = Button(420, 120, 170, 40, "Правила", show_rules)
