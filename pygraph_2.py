...
goblin_l = pygame.image.load('npc_2_l.png')
goblin_l.set_colorkey((255, 255, 255))
goblin_r = pygame.image.load('npc_2_r.png')
...
pol = pygame.image.load('pol_2.png')
pol.set_colorkey((255, 255, 255))
wall_hor = pygame.image.load('wall_hor_2.png')
wall_hor.set_colorkey((255, 255, 255))
wall_ver = pygame.image.load('wall_ver_2.png')
...
npc_bullet = pygame.image.load('npc_bullet_2.png')
